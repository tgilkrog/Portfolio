...
namespace Gui.IngredientServiceRef {
    ...
    public interface IIngredientService {
        ...
        void createIngredient(Gui.IngredientServiceRef.Ingredient i);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIngredientService/createIngredient", ReplyAction="http://tempuri.org/IIngredientService/createIngredientResponse")]
        System.Threading.Tasks.Task createIngredientAsync(Gui.IngredientServiceRef.Ingredient i);
        ...
        Gui.IngredientServiceRef.Ingredient GetIngredient(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIngredientService/GetIngredient", ReplyAction="http://tempuri.org/IIngredientService/GetIngredientResponse")]
        System.Threading.Tasks.Task<Gui.IngredientServiceRef.Ingredient> GetIngredientAsync(int id);
        ...
        Gui.IngredientServiceRef.Ingredient[] getAllIngredients();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIngredientService/getAllIngredients", ReplyAction="http://tempuri.org/IIngredientService/getAllIngredientsResponse")]
        System.Threading.Tasks.Task<Gui.IngredientServiceRef.Ingredient[]> getAllIngredientsAsync();
        ...
        Gui.IngredientServiceRef.Ingredient[] SearchIngedient(string search);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIngredientService/SearchIngedient", ReplyAction="http://tempuri.org/IIngredientService/SearchIngedientResponse")]
        System.Threading.Tasks.Task<Gui.IngredientServiceRef.Ingredient[]> SearchIngedientAsync(string search);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IIngredientServiceChannel : Gui.IngredientServiceRef.IIngredientService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class IngredientServiceClient : System.ServiceModel.ClientBase<Gui.IngredientServiceRef.IIngredientService>, Gui.IngredientServiceRef.IIngredientService {
        ...
        public void createIngredient(Gui.IngredientServiceRef.Ingredient i) {
            base.Channel.createIngredient(i);
        }
        
        public System.Threading.Tasks.Task createIngredientAsync(Gui.IngredientServiceRef.Ingredient i) {
            return base.Channel.createIngredientAsync(i);
        }
        
        public Gui.IngredientServiceRef.Ingredient GetIngredient(int id) {
            return base.Channel.GetIngredient(id);
        }
        
        public System.Threading.Tasks.Task<Gui.IngredientServiceRef.Ingredient> GetIngredientAsync(int id) {
            return base.Channel.GetIngredientAsync(id);
        }
        
        public Gui.IngredientServiceRef.Ingredient[] getAllIngredients() {
            return base.Channel.getAllIngredients();
        }
        
        public System.Threading.Tasks.Task<Gui.IngredientServiceRef.Ingredient[]> getAllIngredientsAsync() {
            return base.Channel.getAllIngredientsAsync();
        }
        
        public Gui.IngredientServiceRef.Ingredient[] SearchIngedient(string search) {
            return base.Channel.SearchIngedient(search);
        }
        
        public System.Threading.Tasks.Task<Gui.IngredientServiceRef.Ingredient[]> SearchIngedientAsync(string search) {
